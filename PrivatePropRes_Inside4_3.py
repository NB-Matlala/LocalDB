...
gp_links = ['{base_url}/for-sale/gauteng/bronkhorstspruit/647',
            '{base_url}/for-sale/gauteng/east-rand/43',
            '{base_url}/for-sale/gauteng/gauteng-south/812']
...
csv_filename = 'PrivatePropRes(Inside)03.csv'
